...
<section class="site-locator" data-agencies='<?= View::e($agenciesJson) ?>'>
    ...
    <div class="site-map-panel"><div class="site-map-toolbar"><strong>Carte des agences</strong><span data-agency-count><?= count($page->agencies) ?> agence(s)</span></div>
        <div class="site-map" data-site-map aria-label="Carte interactive des agences LBP"><div class="site-map__grid"></div>
            <?php foreach ($page->mappedAgencies as $agency): ?>
                <?= Ui::button((string) $agency['marker_number'], ['variant' => 'plain', 'type' => 'button', 'class' => 'site-map-marker', 'data-map-marker' => true, 'data-code' => (string) ($agency['code'] ?? ''), 'style' => 'left:' . $agency['marker_left'] . '%;top:' . $agency['marker_top'] . '%;', 'aria-label' => (string) ($agency['name'] ?? '')]) ?>
            <?php endforeach; ?>
        </div>
