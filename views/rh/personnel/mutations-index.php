        ...
        <?php else: ?>
            <div class="finea-table-wrap"><table class="finea-table">
                ...
                <tbody><?php foreach ($mutations as $mutation): ?><tr>
                    ...
                    <td><a href="<?= View::url('rh/personnel/' . (int) $mutation['employee_id']) ?>"><strong><?= View::e($mutation['full_name']) ?></strong></a><small class="rh-table-subtitle"><?= View::e($mutation['employee_number']) ?></small></td>
