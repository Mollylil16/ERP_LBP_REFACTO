        ...
        <form method="post" action="<?= View::url(ltrim($formAction, '/')) ?>" class="rh-employee-form">
            ...
            <section class="finea-section-card">
                ...
                <div class="rh-form-grid">
                    ...
                    <div class="finea-field"><label>Sexe</label><select class="finea-select" name="gender"><option value="">Non renseigne</option><option value="male" <?= ($employee['gender'] ?? '') === 'male' ? 'selected' : '' ?>>Masculin</option><option value="female" <?= ($employee['gender'] ?? '') === 'female' ? 'selected' : '' ?>>Feminin</option><option value="other" <?= ($employee['gender'] ?? '') === 'other' ? 'selected' : '' ?>>Autre</option></select></div>
            ...
            <section class="finea-section-card">
                ...
                <div class="rh-form-grid">
                    ...
                    <div class="finea-field"><label>Nombre d'enfants</label><input class="finea-input" min="0" type="number" name="children_count" value="<?= $value('children_count') ?>"></div>
                </div>
            </section>
