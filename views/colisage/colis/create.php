...
<div class="finea-shell">
    <div class="finea-container">
        ...
        <form action="<?= View::url('colisage/colis') ?>" method="POST" id="form-colis" style="margin-top: 1.5rem;">
            <?= Csrf::input() ?>
            ...
            <div class="finea-section-card" style="margin-bottom:1.5rem;">
                ...
                <div class="finea-table-wrap">
                    <table class="finea-table" id="table-marchandises">
                        <thead>
                            <tr>
                        ...
                        <tbody id="tbody-marchandises">
                            <tr class="ligne-marchandise">
                                ...
                                <td>
                                    <button type="button" class="finea-action-btn finea-action-btn--ghost btn-delete-ligne" title="Supprimer" style="padding: 4px 8px; min-height: auto;">
