...
<div class="finea-shell">
    <div class="finea-container">
        ...
        <?= Ui::pageHeader(
            ...
            'Saisie de la fiche de colisage conforme à la facture LBP-CI.',
            [
                'eyebrow' => 'Nouveau Colis — Facture & Colisage',
                'class' => 'rh-hero-white',
                'actions' => [
        ...
        <form method="post" action="<?= View::url('colisage/parcels/enregistrer') ?>">
            ...
            <!-- ÉTAPE 2 : Détails de l'expédition (format facture LBP) -->
            <div class="rh-form-step-card">
                <div class="rh-step-badge">ÉTAPE 2</div>
                <h3 class="rh-step-title">Détails de l'expédition</h3>
                <div class="rh-form-grid-3">
                    ...
                    ], 'export_aerien', ['label' => 'TRAFIC (type de fret)', 'required' => true]) ?>
            ...
            <!-- ÉTAPE 3 : Marchandises (Format tableau facture LBP) -->
            <div class="rh-form-step-card">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTotals() {
        ...
        // EUR Conversion
        const tauxChangeEur = <?= json_encode($tauxChangeEur ?? 655.957) ?>;
