...
import { IsNumber, IsEnum, IsOptional, IsString, IsDateString, ValidateIf } from 'class-validator';
...
export class CreatePaiementDto {
    ...
    @ApiProperty({ example: 'CHQ-123456', required: false, description: 'Alias for reference_paiement' })
    @IsOptional()
    @IsString()
