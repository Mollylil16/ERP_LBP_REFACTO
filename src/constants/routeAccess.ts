...
export const ROUTE_ACCESS = {
  ...
  exploitationPrestataires: [
    ...
    PERMISSIONS.EXPLOITATION.PRESTATAIRES_FACTURES_READ,
    PERMISSIONS.EXPLOITATION.PRESTATAIRES_REGLEMENTS_READ,
    PERMISSIONS.EXPLOITATION.PRESTATAIRES_RETRAITS_HUB_READ,
  ],
