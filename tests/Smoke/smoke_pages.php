...
$ecrans = [
    ...
    'Départs à valider' => '/colisage/envois/a-valider',
...
foreach ([
    ...
    'Fiche du départ' => ['lbp_dossiers_envoi', '/colisage/envois/', ''],
    'Fiche PDF du départ' => ['lbp_dossiers_envoi', '/colisage/envois/', '/pdf'],
