...
final class SystemTestService
{
    ...
    private function modules(): array
    {
        return [
            ...
            'site-admin' => ['slug' => 'site-admin', 'label' => 'Site internet', 'code' => 'WEB', 'accent' => '#14b8a6', 'tables' => ['permission_entities'], 'routes' => ['/site-admin', '/site-admin/dashboard', '/site'], 'pages' => ['/site-admin', '/site-admin/dashboard', '/site'], 'views' => ['site_admin/dashboard', 'site/index']],
