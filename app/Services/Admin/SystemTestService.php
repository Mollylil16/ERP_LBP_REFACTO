...
final class SystemTestService
{
    ...
    private function modules(): array
    {
        return [
            ...
            'colisage' => ['slug' => 'colisage', 'label' => 'Facturation', 'code' => 'COL', 'accent' => '#f97316', 'tables' => ['permission_entities'], 'routes' => ['/colisage', '/colisage/dashboard'], 'pages' => ['/colisage', '/colisage/dashboard'], 'views' => ['colisage/dashboard', 'colisage/_navigation']],
            ...
            'facturation' => ['slug' => 'facturation', 'label' => 'Recherche & Audit', 'code' => 'FAC', 'accent' => '#16a34a', 'tables' => ['permission_entities'], 'routes' => ['/facturation', '/facturation/dashboard'], 'pages' => ['/facturation', '/facturation/dashboard'], 'views' => ['facturation/dashboard', 'facturation/_navigation']],
