    ...
    private function modules(): array
    {
        return [
            ...
            'site-admin' => [
                ...
                'tables' => ['website_pages', 'website_services', 'website_leads', 'website_branding', 'website_slides', 'website_products', 'website_forum_topics'],
                'routes' => ['/site-admin', '/site-admin/dashboard', '/site-admin/configuration', '/site', '/site/tracking', '/site/shop', '/site/forum'],
                'pages' => ['/site-admin', '/site-admin/dashboard', '/site-admin/configuration', '/site', '/site/tracking', '/site/shop', '/site/forum'],
                'views' => ['site_admin/dashboard', 'site_admin/configuration', 'site/index', 'site/tracking', 'site/shop', 'site/forum'],
            ],
