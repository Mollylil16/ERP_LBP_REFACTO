...
class EmployeePortalController extends BaseController
{
    ...
    {
        $this->service = new EmployeePortalService(new EmployeePortalRepository(Database::getConnection()));
    }
    ...
    public function index(): void
    {
        ...
        try {
            $this->view('employee/dashboard', $this->viewData('Mon espace employé', 'dashboard') + $this->service->dashboard(Auth::user()));
